    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card">
                        <img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            class="card-img-top category-img" alt="Electronics">
                        <div class="card-body text-center">
                            <h5 class="card-title">Electronics</h5>
                            <a href="{{ route('products.index') }}" class="btn btn-outline-primary">Shop Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card">
                        <img src="https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            class="card-img-top category-img" alt="Fashion">
                        <div class="card-body text-center">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="https://images.unsplash.com/photo-1556911220-bff31c812dba?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            class="card-img-top category-img" alt="Home & Garden">
                        <div class="card-body text-center">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="https://images.unsplash.com/photo-1546868871-7041f2a55e12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1064&q=80"
                            class="card-img-top category-img" alt="Beauty">
                        <div class="card-body text-center">
                        ...
                        <div class="card h-100">
                            <div class="action-icons">
                                <form action="{{ route('wishlist.store', $product->id) }}" method="POST"
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-primary" title="Add to Wishlist">
                                        <i class="fas fa-heart"></i>
                                    </button>
                                </form>

                                <a href="{{ route('product.show', ['slug' => $product->slug]) }}" title="Quick View"><i
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <button type="submit" class="btn btn-dark" id="subscribe" type="button">Subscribe</button>
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <img src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                        class="img-fluid rounded" alt="Special Offer" style="max-height: 300px;">
                </div>
            </div>
        </div>
    </section>
